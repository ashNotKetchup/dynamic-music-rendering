# May 26th, working with Bror Havnes:

## Pre-Session: 

Bror and I met in Goldsmiths EMS 3, a sound treated studio space for electroacoustic music. I mic-ed his tenor saxophone with a dynamic microphone, into channel one of my max msp patch. Preprocessing and pitch detection occurs in a subpatcher called "sysInputNote" which compresses, then pitch detects incoming notes (courtesy of [volker Böhm's Max/Msp objects](https://vboehm.net/downloads))

I start with some basic explanations of my idea, then demonstrate to him how pitch tracking in Max works, building a suitable algorithm with his sax warmups as input. After that, I demonstrate web-based version of the [L-System](https://junshern.github.io/algorithmic-music-tutorial/part1.html). Then we load into and troubleshoot my Max patch with some visuals from processing. 
...
![A list of musical notes. The top left is circled: ](/assets/Screenshot2022-05-26_18_22_34.png)

![A list of musical notes](/assets/Screenshot2022-05-26_18_25_33.png)

(He begins to notice and remark on repeated patterns in his playing, and remarks that the whole isnt as random globally as it first appears locally)
...
I encourage him to play “outside” and improvise around the notes. He begins to become conscious that once he plays the next note in the list, it triggers more notes (I also transpose output so that it makes sense for his Bb instrument). This seems to have the most comfortable compromise, and he enters somewhat of a flow state. He starts to understand the relationship between what he is playing and what is being displayed, we both remark at him becoming stuck in a loop of drawing variations of “hahaha” on the screen (this is because the pitch class converter I am using still uses ‘h’ in place of ‘b’. Bror, as a Norwegian, is comfortable with this notation too, so I didn’t change it….I will though). His level of autonomy has also increased though, and there emerges a clear distinction betewen what he wants to play and his return to the score – knowing what note, as well as what set of notes, is next begins to inform his improvisation... if he sees a string of notes which he thinks will line up, he will play that without too much noodling. If he believes there is a jarring transition to come, he eases it with mindful improv. The rate at which the notes are generated/completed begins to ebb and flow, ,aking the resultant piece more dynamic despite its structure.

> **Meta:** clearly warning musicians about harsh changes to tonal space provides them a useful oppurtunity to choose whether or not to ease that transition. Of course a lack of warning can also be utilised to the opposite effect
